...
2. Download [AboutYou.csv](https://facultyweb.cs.wwu.edu/~wehrwes/courses/csci141_23w/lectures/L16/code/AboutYou.csv). Write a program that counts and prints the number of **unique** lines in the file. Be sure that the text file and your Python program are saved in the same directory.
